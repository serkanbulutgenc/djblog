...
from django.contrib.auth.views import (
    ...
    PasswordResetView as BasePassordResetView,
...
from apps.account.forms import CustomUserLoginForm, PasswordChangeForm, SignupForm,PasswordResetForm, SetPasswordForm
